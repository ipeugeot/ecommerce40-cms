 ...
 */
package it.esselunga.internet.core.models;
...
import it.esselunga.internet.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "ecommerce40-cms/components/helloworld");
